# The package includes installation a visual inference platform that supports multiple YOLO versions theme switching and real-time inference.

# Body

The package includes installation, a visual inference platform that supports multiple YOLO versions, theme switching, and real-time inference.

Visual reasoning platform, supports multiple YOLO versions, theme switching, real-time inference, default release version, if you need source code please click three [fire][fire][fire
